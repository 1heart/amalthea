...
\title{Hypersphere Mean Comparisons}


\author{Zela Taino, Yixin Lin}
...
Karcher means is a geometric mean of vairous matrices and an extension
of the well known geometric mean of two matrices. It is also referred
to as the Riemannian geometric mean. In our investigastion, we used
...
is stated in Algorithm 1. In oder to do this we must incorporate an
...
Unlike the Karcher mean, Sphereical K-means does not go along the
...
But both approaches failed in the case where the angles were the opposite. 

\begin{figure}[h]
\begin{centering}
\includegraphics[width=2in]{/Users/glizelataino/Downloads/fig1}\includegraphics[width=2in]{/Users/glizelataino/Downloads/fig2} 
\par\end{centering}

\begin{centering}
\includegraphics[width=2in]{/Users/glizelataino/Downloads/fig3}\includegraphics[width=2in]{/Users/glizelataino/Downloads/fig4}
\par\end{centering}

\begin{centering}
\includegraphics[width=2in]{\string"/Users/glizelataino/Downloads/fig5 (1)\string".png}
\par\end{centering}
