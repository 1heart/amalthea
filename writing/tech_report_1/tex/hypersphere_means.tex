...
\begin{figure}[ht]
\begin{centering}
\includegraphics[width=2in]{img/fig1}\includegraphics[width=2in]{img/fig2} 
\par\end{centering}

\begin{centering}
\includegraphics[width=2in]{img/fig3}\includegraphics[width=2in]{img/fig4}
\par\end{centering}

\begin{centering}
\includegraphics[width=2in]{img/fig5.png}
\par\end{centering}
