...
%   Adrian M. Peter
%--------------------------------------------------------------------------
function [distMats basesLocs]  = euclidDistsBetwCoeffs(wdeSet)

wName = wdeSet.wName; startLevel = wdeSet.startLevel; stopLevel = wdeSet.stopLevel;
coeffsIdx = wdeSet.coeffsIdx; sampleDataSupp = wdeSet.sampleSupp;
