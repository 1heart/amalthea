...
%                         inputFileName ' ' outputFileName]);
    ...
    [status shellText] = unix([prefix 'linAssignBinFile ' inputFileName ' ' prefix outputFileName]);
end

% try
    load([prefix outputFileName]);
% catch
%     a = 1;
% end
...
% delete([prefix inputFileName]);
delete([prefix outputFileName]);
