...
function sqrtP = plotWDE_Par(isovalue, supportVals, wdeSet,...
                        coeffs, coeffsIdx)
...
scalingTransRX    = translationRange(wdeSet.sampleSupp(1,:),...
                        wdeSet.wName, wdeSet.startLevel);
scalingShiftValsX = [scalingTransRX(1):scalingTransRX(2)];
scalingTransRY    = translationRange(wdeSet.sampleSupp(2,:),...
                        wdeSet.wName, wdeSet.startLevel);
scalingShiftValsY = [scalingTransRY(1):scalingTransRY(2)];
scalingTransRZ = translationRange(wdeSet.sampleSupp(3,:),...
                        wdeSet.wName, wdeSet.startLevel);
scalingShiftValsZ = [scalingTransRZ(1):scalingTransRZ(2)];

% Set up correct basis functions.
% [father, mother] = basisFunctions(wdeSet.wName);
...
coeffBlock = coeffs(coeffsIdx(1,1):coeffsIdx(1,2));
