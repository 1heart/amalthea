...
%                       Default: 5
%   varargin          - various optional parameters:
%                       varargin(1) = 1: only use scaling functions to 
...
function [coeffs, coeffsIdx] = mlWDE1D(samps, wName, scalingStartLevel, ...
...
[coeffs coeffsIdx] = initializeCoefficients(scalingStartLevel, waveletStopLevel, ...
                                            sampleSupport, wName, scalingOnly, initType, samps, bins);
...
% Plot the Hessian structure.
%plotHessianStructure(currHessian);
