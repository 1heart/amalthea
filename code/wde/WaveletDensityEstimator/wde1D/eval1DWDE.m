...
%
% Inputs:
%   pnts              - Nx1 matrix of values where we want to evaluate the
%                       density.
%   sampleSupport     - 1x2 matrix where the 1st row has [xMin xMax].
...
%     USA
%--------------------------------------------------------------------------
function wdeVals = eval1DWDE(pnts, sampleSupport, wName, startLevel, stopLevel,...
...
for s = 1 : numSamps
    ...
    % over our entire 1D sampling grid.
